...
export function AppLayout({ children }: { children: ReactNode }) {
  ...
  // This guard is crucial if AuthProvider has finished, but user is not in a valid state for app routes.
  // AuthProvider should be redirecting in these cases. This spinner shows during that redirect.
